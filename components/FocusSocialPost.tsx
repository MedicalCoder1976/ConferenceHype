    ...
    <section className="border border-ink/10 bg-white p-5 shadow-panel">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-xl font-black text-ink">
          Focus a URL, X post, or Instagram post
        </h2>
      </div>
      <p className="mt-2 text-sm leading-6 text-ink/65">
        Paste a URL, X post, Instagram post, or attendee tip. It becomes a
        high-energy review segment before anything airs.
      </p>
      {message ? (
      ...
      <label className="mt-4 block text-xs font-black uppercase text-ink/60">
        URL, X post, or Instagram post
      </label>
      <input
        value={postUrl}
        onChange={(event) => setPostUrl(event.target.value)}
        placeholder="x.com/asco, instagram.com/reel/..., or https://example.com/story"
