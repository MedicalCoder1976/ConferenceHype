...
export default async function AdminPage({ searchParams }: AdminPageProps) {
  ...
  return (
    <AdminShell>
      <div className="mb-4 flex justify-end"><Link href="/admin/journal-articles" className="border border-ink/20 bg-white px-3 py-2 text-xs font-black uppercase">Journal article reconciliation</Link></div>
