...
async function main() {
  ...
  const video = await uploadVideoToYoutube({
    ...
    description: [
      "ConferenceHype turns newly indexed medical journal articles and conference information into trusted, PubMed-grounded, operator-reviewed medical education broadcasts.",
      "",
